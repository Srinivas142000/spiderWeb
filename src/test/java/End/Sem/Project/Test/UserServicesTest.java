...
class UserServicesTest {
    ...
    @Mock
    private CommunityServices cms = Mockito.mock(CommunityServices.class); // This can also be mocked

    @InjectMocks
    private UserServices us; // UserServices will be instantiated with the mocked dependencies
    ...
    @BeforeEach
    void setUp() {
        us = new UserServices(ud, umd, cdao, ldao, cms);
        userDTO = new UserDTO();
